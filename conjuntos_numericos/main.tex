...
\item \tp{Fundamentos} - Resolva as questões do livro texto indicadas a seguir 
  \begin{enumerate}
    ...
    \item \tp{Cálculo das raízes}  Questões 1-6
\item \tp{Simplificação de expressões} Questões 23-32
\item \tp{Racionalização} Questões 33-38
\item \tp{Potência} Questões 41-42
\end{enumerate}

\item \tp{Tópicos avançados}
  \begin{enumerate}
  \item \tp{Simplificação} Questões 53-63
  \item \tp{Simplificação de radicais} Questões 61-70
    \item \tp{Inequações} Questões 71-79
    \end{enumerate}
